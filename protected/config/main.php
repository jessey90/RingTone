...
return array(
    ...
    'components' => array(
        ...
        'db'=>(!APP_DEPLOYED)?
                                                         array(    //LOCALHOST
                                                        'class' => 'CDbConnection',
                                                        'connectionString' => 'mysql:host=yii.dev;dbname=nhaccho',
                                                        'username' => 'root',
                                              			 'password' => '',
                                                         'charset' => 'UTF8',
                                                        ...
                                                        array(
                                                         'class' => 'CDbConnection',
                                                            'connectionString' => 'mysql:host=192.168.6.59;dbname=fun_ringtone',
                                                                                                       'username' => 'fun_ringtone',
                                                                                                        'password' => '123456',
                                                        'charset' => 'UTF8',
                                                        'tablePrefix' => '',
                                                        'emulatePrepare' => true,
    ...
    'params' => array(
        ...
        'myEmail'=>'[dinhtuananh1990@gmail.com]',
        'gmail_password'=>'[luudUoc77]',
